$(document).ready(function() {
    ...
    function displayCart() {
        ...
        for (var i in cartArray) {
            output += "<li>" + cartArray[i].name + " " + cartArray[i].count + " x " + "$" + cartArray[i].price + " = " + "$" + cartArray[i].total + " <button class='sub-item' data-menu-item='" + cartArray[i].name + "'> - </button> " + " <button class='plus-item' data-menu-item='" + cartArray[i].name + "'> + </button> " + " <button class='delete-item' data-menu-item='" + cartArray[i].name + "'> Remove </button> " + "</li>"
        }
        $("#show-cart").html(output);
        $("#total-cart").html(shoppingCart.totalCart());
        $("#item-count").html(shoppingCart.countCart());
    }
    // -------------- Function to add, delete, or remove item from cart directly form cart page -----------
